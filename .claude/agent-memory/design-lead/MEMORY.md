...
- [Location permission model](location-permission.md) — When-In-Use precise, primed, never blocks first capture.
- [Accessibility baseline](a11y-baseline.md) — Dynamic Type, VoiceOver custom actions for swipe, no color-only state, 44pt, reduced motion.
- [Native-feel risks to watch](native-feel-risks.md) — owner is new to iOS; the web-shaped-UI failure modes to catch in review.
