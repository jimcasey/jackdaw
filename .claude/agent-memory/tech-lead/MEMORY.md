...
- [Slice 1 spec](slice-1-spec.md) — Vault bookmark write+verify harness in docs/slices/; Talon seam seed, UserDefaults storage, no-iOS-entitlement fact, T2/T1 PASS/FAIL protocol.
