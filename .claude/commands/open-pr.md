...
argument-hint: [optional title or focus, e.g. "#14 export destination" or "draft"]
---
...
3. **Write the PR from the diff, not from memory.**
   ...
   - **Body:** what changed and why; the issue it closes (`Closes #N`) and the ADR
     or spec it implements (link it — `docs/specs/…`, `docs/adr/…`); anything the
     owner can't verify headlessly
